...
@Component({
    templateUrl: './list-not-ocl-customers.component.html',
    styleUrls: ['./list-not-ocl-customers.component.scss'],
})
export class ListNotOclCustomersComponent implements OnInit, OnDestroy {
    listApplications;
    localities = [];
    form = this.fb.group({
        minutes: [''],
    ...
    getListApplications(page = 1) {
        this.creditApplicationService
            .getListNoneOclObservation(page, this.form.value)
